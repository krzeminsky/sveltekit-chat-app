...
export function showAddChatMemberDialog(dialog: Dialog, attachmentHandler: SocketAttachmentHandler, chatMembers: string[], searchHandler: (val: string) => Promise<SearchResult>, onSelect: (member: string) => void) {    
    dialog.showDialog({
