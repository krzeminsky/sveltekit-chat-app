<script lang="ts">
    import { getReactionCount } from "$lib/chat/reactions";
...
<h1 class="w-fit relative px-5 py-2 break-words text-white max-w-[80%]  {left? 
...
{content}
{#if reactions}
<div class="absolute bottom-full right-3 px-2 py-1 bg-gray-800 rounded-full">
