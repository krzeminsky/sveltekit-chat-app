...
<div class="relative flex-shrink-0 align-middle aspect-square pointer-events-none rounded-full overflow-hidden inline-flex justify-center items-center" style="height: {size}px">
